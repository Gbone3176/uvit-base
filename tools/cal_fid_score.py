...
if __name__ == '__main__':
    ...
    parser.add_argument('out_path', type=str, nargs=1,
                        help=('Path to save the images statistic'))
    ...
    save_statistics_of_path(args.path[0], args.out_path[0], args.device, args.batch_size, args.dims, args.num_workers)
    print(f'statistics of file {args.path} has been saved to {args.out_path}')