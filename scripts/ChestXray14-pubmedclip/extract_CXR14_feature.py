...
def main(resolution=256):
    ...
    if args.split == "train":
        ...
        datas = ChestXray14Database(root='/storage/dataset/ChestXray14',
                             ...
                             size=resolution,
                             mode='train')
        save_dir = f'/storage/U-ViT/assets/datasets/ChestXray14-{resolution}_features-pubmedclip/train'
    elif args.split == "val":
        # datas = ChestXray14Database(root='/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/datasets/ChestXray14',
        ...
        datas = ChestXray14Database(root='/storage/dataset/ChestXray14',
                             ...
                             size=resolution,
                             mode='valid')
        save_dir = f'/storage/U-ViT/assets/datasets/ChestXray14-{resolution}_features-pubmedclip/val'
    else:
